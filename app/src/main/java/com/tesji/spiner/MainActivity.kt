...
import com.tesji.spiner.model.PolizasModel

class MainActivity : AppCompatActivity() {

    // ---- Manera de conectar con el modelo y que este disponible a todos ----
    private val poliza = PolizasModel()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnCalcular.setOnClickListener() {
            ...
            if (noPoliza == 0) {
                Toast.makeText(applicationContext, "Seleccione una poliza", Toast.LENGTH_LONG)
                    .show()
            } else {
